...
/**
 * Asadmin command to configure the Event Bus notifier with the monitoring service.
...
@RestEndpoints({
        @RestEndpoint(configBean = MonitoringServiceConfiguration.class,
                ...
                description = "Configures Event Bus Notifier for Monitoring Service")
})
public class EventBusMonitoringNotifierConfigurer extends BaseSetNotifierConfigurationCommand {

    @Override
    public void execute(final AdminCommandContext context) {
        configureNotifier(context, "set-eventbus-notifier-configuration");
        configureService(context, "set-jmx-monitoring-configuration", "eventbus-notifier");
    }
