...
public class EventBusHealthCheckNotifierConfigurer extends BaseSetNotifierConfigurationCommand {

    @Override
    public void execute(AdminCommandContext context) {
        configureNotifier(context, "set-eventbus-notifier-configuration");
        configureService(context, "set-healthcheck-configuration", "eventbus-notifier");
    }
}