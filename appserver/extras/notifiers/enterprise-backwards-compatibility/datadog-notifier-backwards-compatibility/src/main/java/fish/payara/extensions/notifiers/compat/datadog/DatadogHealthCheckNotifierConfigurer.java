...
public class DatadogHealthCheckNotifierConfigurer extends BaseSetNotifierConfigurationCommand {

    @Override
    public void execute(AdminCommandContext context) {
        configureNotifier(context, "set-datadog-notifier-configuration");
        configureService(context, "set-healthcheck-configuration", "datadog-notifier");
    }
}