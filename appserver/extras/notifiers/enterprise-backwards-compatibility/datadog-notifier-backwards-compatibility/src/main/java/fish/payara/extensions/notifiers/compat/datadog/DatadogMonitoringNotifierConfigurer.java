...
public class DatadogMonitoringNotifierConfigurer extends BaseSetNotifierConfigurationCommand {

    @Override
    public void execute(final AdminCommandContext context) {
        configureNotifier(context, "set-datadog-notifier-configuration");
        configureService(context, "set-jmx-monitoring-configuration", "datadog-notifier");
    }
