...
/**
 * A custom serializer that determines what to write to the discord endpoint
 * 
 * @author Matthew Gill
 */
public class DiscordSerializer extends StdSerializer<PayaraNotification> {
    ...
    public void serialize(PayaraNotification value, JsonGenerator gen, SerializerProvider provider) throws IOException {
        ...
        gen.writeStringField("content", getDetailedSubject(value) + "\n" + value.getMessage());
        gen.writeEndObject();
    }
    ...
    public static Module createModule() {
        SimpleModule module = new SimpleModule("DiscordModule");
        module.addSerializer(PayaraNotification.class, new DiscordSerializer());
        return module;
    }
