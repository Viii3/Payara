...
public class GetTeamsNotifierConfigurationCommand extends BaseGetNotifierConfigurationCommand<TeamsNotifierConfiguration> {
    
    @Override
    protected Map<String, Object> getNotifierConfiguration(TeamsNotifierConfiguration configuration) {
