...
// END OF IASRI 4657979
    ...
    protected synchronized Class<?> loadClass(String name, boolean resolve)
        ...
        if (useMyFaces && !delegateLoad && (name.startsWith("javax.faces") || name.startsWith("com.sun.faces"))) {
    ...
    private void clearBeanELResolverPropertiesCache(Object resolver, Class<?> elResolverClass) throws Exception {
        ...
        Optional<Field> propertiesField = Optional.ofNullable(CachingReflectionUtil
        ...
        Optional<Field> mapField = Optional.ofNullable(CachingReflectionUtil
        ...
        Optional<Method> cleanupMethod = Optional.ofNullable(CachingReflectionUtil
