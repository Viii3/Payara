...
public final class EventTypes<T> {
    ...
    public static final String SERVER_READY_AFTER_CHECKPOINT_NAME= "server_ready_after_checkpoint";
    ...
    public static final EventTypes<?> SERVER_READY_AFTER_CHECKPOINT = create(SERVER_READY_AFTER_CHECKPOINT_NAME);
